...
import { postStaff } from "../redux/action/staffs";
import { addStaffToDepartment } from "../redux/action/departments";
const initialState = {
    name: '',
    doB: '',
    salaryScale: '',
...
const StaffList = () => {
    ...
    const handleSubmit = (values, dispatcher) => {
        ...
        dispatch(addStaffToDepartment(departments[index].id));
        dispatcher(actions.reset('staff', initialState));
